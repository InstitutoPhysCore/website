<footer class="bg-zinc-900">
	<div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 lg:pt-24">
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
			<div>
				<div class="flex justify-center sm:justify-start">
					<x-navbar.title/>
				</div>
				<p class="mt-6 max-w-md text-center leading-relaxed text-gray-400 sm:max-w-xs sm:text-left"> Visando a democratização da ciência para estudantes de todas as origens! Primeiro projeto de cosmologia, astronomia e astrofísica do Cefet/RJ </p>
			...
			<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
				...
				<div class="text-center sm:text-left">
					<p class="text-lg font-medium text-gray-100">Helpful Links</p>
				...
				<div class="text-center sm:text-left">
					<p class="text-lg font-medium text-gray-100">Contact Us</p>
					<ul class="mt-8 space-y-4 text-sm">
						<li>
		...
		<div class="mt-12 border-t border-gray-100 pt-6">
			<div class="text-center sm:flex sm:justify-between sm:text-left">
				<p class="text-sm text-gray-500">
					...
					<a class="inline-block text-teal-600 underline transition hover:text-teal-600/75" href="#"> Terms & Conditions </a>
					<span>&middot;</span>
					<a class="inline-block text-teal-600 underline transition hover:text-teal-600/75" href="#"> Privacy Policy </a>
				</p>
				<p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 PhysCore</p>
			</div>
		</div>
	</div>
</footer>